...
then
	...
	./gr_single_dir.pl -i "$output_dir/sar.cpu*.dat" -o $output_dir/sar_cpu_idle -t "sar individual CPU pct_idle" -b "sar." -e ".dat" -c 3 -hl "samples every 60 sec"
	./gr_single_dir.pl -i "$output_dir/sar_cpu_all.dat" -o $output_dir/sar_cpu_all -t "sar CPU" -b "sar_cpu_all" -e ".dat" -c 0,1,2,3 -hl "samples every 60 sec"
fi
