...
./gr_OneFileSomeData.pl -i $output_dir/vmstat.dat -o $output_dir/vmstat_cpu -t "vmstat CPU" -v "%" -hl "samples every 60 sec" -c 12,13,15
...
#parse iostat
./parse_iostat.pl -i $input_dir/io.txt -o $output_dir/iostat 
...
#parse sar file
echo "parse sar output"
./parsedata.pl -f ./dbt3.sar.config -s sarb -v 4.0.3
./parsedata.pl -f ./dbt3.sar.config -s sarB -v 4.0.3
./parsedata.pl -f ./dbt3.sar.config -s tsaru -v 4.0.3
./parsedata.pl -f ./dbt3.sar.config -s sarr -v 4.0.3
./parsedata.pl -f ./dbt3.sar.config -s sarW -v 4.0.3
./parsedata.pl -f ./dbt3.sar.config -s Usar -v 4.0.3

#generate data based on sar .dat files
./gr_ManyFilesSomeData.pl -i "$output_dir/cpu.*.dat" -o $output_dir/sar_cpu -t "sar individual CPU " -v "%" -hl "sample every 60 second" -c 0,

./gr_OneFileAllData.pl -i $output_dir/sar_io.dat -o $output_dir/sar_io -t "sar IO all" -v "%" -hl "sample every 60 second"

./gr_OneFileAllData.pl -i $output_dir/sar_cpu_all.dat -o $output_dir/sar_cpu_all -t "sar CPU all" -hl "sample every 60 second"
...
#parse x_cons output
#../analyzetool/parse_xcons_io.pl -i "$input_dir/x_cons*.out" -o $output_dir -p $input_dir/param.out

#./gr_ManyFilesSomeData.pl -i "$output_dir/dataio*.dat" -o $output_dir/xcons_dataread -c 1, -b "dataio" -e ".dat"

#./gr_ManyFilesSomeData.pl -i "$output_dir/dataio*.dat" -o $output_dir/xcons_datawrite -c 2,  -b "dataio" -e ".dat"

#./gr_ManyFilesSomeData.pl -i "$output_dir/dataio*.dat" -o $output_dir/xcons_datatotal -c 3, -b "dataio" -e ".dat"

#./gr_ManyFilesSomeData.pl -i "$output_dir/logio*.dat" -o $output_dir/xcons_logwrite -c 3,

./wb_tableFromSuffixGlob.pl -g png -d $DBT3_INSTALL_PATH/data_collect/power_2.4.18_2/plot -o  $DBT3_INSTALL_PATH/data_collect/power_2.4.18_2/plot/graphs.html -i
