...
be at the start of the statement ( ie "*.dat" ) For that reason,
the directory should be specified separately
...
my ( $glob, $hlp, $outfile, $title, $dir, $index, $configfile, $writeme );
