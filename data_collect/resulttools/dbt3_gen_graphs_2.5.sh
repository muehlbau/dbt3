...
#./wb_tableFromSuffixGlob.pl -g png -d $DBT3_INSTALL_PATH/data_collect/power_2.5.62-mm1/plot -o  $DBT3_INSTALL_PATH/data_collect/power_2.5.62-mm1/plot/graphs.html -i
